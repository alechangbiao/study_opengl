...
// NOTE: Instead of using glGetError, glDebugMessageCallback is a better alternative for OpenGL 4^
...
int main(void)
{
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        // GLClearError();
        // /* Draw a triangle */
        // glDrawElements(GL_TRIANGLES, 6, GL_INT, nullptr); // <-- instead of using glDrawArrays
        // ASSERT(GLLogCall());
...
// g++ -pthread -o dealing_errors dealing_errors.cpp -lglfw -lGLU -lGL -lXrandr -lXxf86vm -lXi -lXinerama -lX11 -lrt -ldl -lGLEW
