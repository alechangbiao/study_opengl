...
int main(void)
{
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        /* Draw a triangle */
        glDrawElements(GL_TRIANGLES, 6, GL_UNSIGNED_INT, nullptr); // <-- instead of using glDrawArrays
...
// g++ -pthread -o index_buffer index_buffer.cpp -lglfw -lGLU -lGL -lXrandr -lXxf86vm -lXi -lXinerama -lX11 -lrt -ldl -lGLEW
